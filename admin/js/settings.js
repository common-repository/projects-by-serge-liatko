jQuery(document).ready(function($){
	...
	$('.projects_plugin-settings-page .settings-section h2').each(function(){
	...
	$('.projects_plugin-settings-page .settings-section').first().fadeIn(400,function(){
	...
	$('.sortable-fields-wrapper').sortable({
		placeholder: 'sortable-field ui-state-highlight',
		handle: '.hndl',
		forcePlaceholderSize: true
	});
	$('.sortable-fields-wrapper').disableSelection();
});